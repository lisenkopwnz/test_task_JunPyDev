    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, max_digits=7, validators=[orders.validators.ValidatePrice()])),
        ...
        migrations.AddField(
            model_name='order',
            name='dishes',
            field=models.ManyToManyField(related_name='orders', through='orders.OrderDish', to='orders.dish'),
        ),
    ]
